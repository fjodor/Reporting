...
Xaringan | YAML: output: xaringan::moon_reader<br>basiert auf JavaScript-Bibliothek *remarkjs*<br>präferiertes Format von **Yihui Xie** (u. a. Autor von knitr und rmarkdown)<br>https://yihui.org/en/2017/08/why-xaringan-remark-js/
...
knitr::include_graphics("libs/_Images/Cooles-Bild.jpg")
```
